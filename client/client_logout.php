...
$redirect_to_dashboard = "/ventech_locator/client_dashboard.php";
$redirect_to_login = "/ventech_locator/index.php"; // Or client_login.php if it's the main entry
...
<body>
    ...
    <form id="logoutForm" method="POST" action="client_logout.php" style="display: none;">
